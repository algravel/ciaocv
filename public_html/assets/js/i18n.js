const translations = {
    fr: {
        ...
        "legal.privacy.update_label": "Dernière mise à jour :",
        "legal.privacy.update_date": "12 février 2026",
        "legal.privacy.intro": "Chez CiaoCV, nous croyons que le recrutement doit être humain, transparent et respectueux. La protection de votre vie privée est au cœur de cet engagement. Cette politique explique clairement comment nous traitons vos informations.",
        "legal.privacy.h1": "1. Qui sommes-nous ?",
        "legal.privacy.p1": "CiaoCV est une plateforme de recrutement vidéo éditée par CiaoCV Inc. Nous agissons en tant que responsable du traitement de vos données personnelles.<br>Pour toute question : <a href=\"mailto:bonjour@ciaocv.com\">bonjour@ciaocv.com</a>.",
        "legal.privacy.h2": "2. Quelles données collectons-nous ?",
        "legal.privacy.li1": "<strong>Pour les Candidats :</strong> Informations de profil (nom, courriel, téléphone), CV, et surtout vos <strong>réponses vidéo</strong> aux entrevues.",
        "legal.privacy.li2": "<strong>Pour les Recruteurs :</strong> Informations professionnelles, détails de l'entreprise, offres d'emploi publiées.",
        "legal.privacy.li3": "<strong>Données techniques :</strong> Adresse IP, type de navigateur, et données de navigation pour assurer la sécurité et la performance du site.",
        "legal.privacy.h3": "3. Pourquoi utilisons-nous vos données ?",
        "legal.privacy.p3": "Nous utilisons vos données pour :",
        "legal.privacy.use1": "<strong>Permettre le recrutement :</strong> Transmettre vos candidatures vidéo aux recruteurs concernés.",
        "legal.privacy.use2": "<strong>Améliorer l'expérience :</strong> Vous notifier du statut de vos candidatures ou de nouvelles opportunités.",
        "legal.privacy.use3": "<strong>Sécuriser la plateforme :</strong> Prévenir la fraude et assurer la confidentialité des échanges.",
        "legal.privacy.h4": "4. Avec qui partageons-nous vos données ?",
        "legal.privacy.p4_1": "Vos données de candidature (vidéos, CV) ne sont accessibles qu'aux <strong>recruteurs</strong> des entreprises auxquelles vous postulez. Nous ne vendons <strong>jamais</strong> vos données à des tiers publicitaires.",
        "legal.privacy.p4_2": "Nous collaborons avec des sous-traitants de confiance pour l'hébergement (ex: serveurs sécurisés au Canada/USA) et l'envoi de courriels, qui sont tenus à de strictes obligations de confidentialité.",
        "legal.privacy.h5": "5. Sécurité de vos vidéos",
        "legal.privacy.p5": "Vos entrevues vidéo sont stockées de manière sécurisée et chiffrée. Elles ne sont consultables que via notre plateforme sécurisée par les recruteurs autorisés.",
        "legal.privacy.h6": "6. Vos droits",
        "legal.privacy.p6": "Vous gardez le contrôle. Vous pouvez à tout moment demander :",
        "legal.privacy.rights1": "L'accès à vos données.",
        "legal.privacy.rights2": "La rectification d'informations inexactes.",
        "legal.privacy.rights3": "La suppression complète de votre compte et de vos vidéos (« droit à l'oubli »).",
        "legal.privacy.contact": "Pour exercer ces droits, écrivez-nous simplement à <a href=\"mailto:bonjour@ciaocv.com\">bonjour@ciaocv.com</a>.",
        "legal.privacy.h7": "7. Cookies",
        "legal.privacy.p7": "Nous utilisons des cookies essentiels au fonctionnement du site (session, sécurité) et des outils d'analyse anonymes pour comprendre comment notre site est utilisé, sans vous tracer individuellement.",
        "legal.privacy.h8": "8. Modifications",
        "legal.privacy.p8": "Cette politique peut évoluer. En cas de changement majeur, nous vous en informerons par courriel ou via une notification sur la plateforme.",

        "legal.terms.title": "Conditions d'utilisation",
        "legal.terms.update_label": "Dernière mise à jour :",
        "legal.terms.update_date": "12 février 2026",
        "legal.terms.intro": "Bienvenue sur CiaoCV. En utilisant notre plateforme, vous acceptez de jouer selon les règles définies ci-dessous. Notre but est de créer un environnement de recrutement sûr, professionnel et bienveillant.",
        "legal.terms.h1": "1. Objet du service",
        "legal.terms.p1": "CiaoCV est une plateforme SaaS permettant aux entreprises (« Recruteurs ») de créer des processus de présélection vidéo et aux chercheurs d'emploi (« Candidats ») d'y répondre par vidéo. Nous fournissons les outils techniques, mais nous n'intervenons pas dans les décisions d'embauche.",
        "legal.terms.h2": "2. Inscription et Accès",
        "legal.terms.p2": "Pour utiliser CiaoCV, vous devez créer un compte. Vous vous engagez à fournir des informations exactes et à garder vos identifiants confidentiels. Vous êtes responsable de toute activité sur votre compte.",
        "legal.terms.h3": "3. Engagements de l'utilisateur",
        "legal.terms.p3_1": "<strong>Candidats :</strong> Vous vous engagez à répondre aux questions de manière authentique et respectueuse. ",
        "legal.terms.p3_2": "<strong>Recruteurs :</strong> Vous vous engagez à utiliser la plateforme pour des besoins réels de recrutement, à ne pas discriminer les candidats, et à respecter la confidentialité de leurs vidéos.",
        "legal.terms.p3_3": "Il est strictement interdit de publier du contenu haineux, diffamatoire, pornographique ou illégal sur CiaoCV.",
        "legal.terms.h4": "4. Propriété Intellectuelle",
        "legal.terms.li4_1": "<strong>Vos contenus :</strong> Les vidéos des candidats restent leur propriété. En les soumettant, vous accordez à CiaoCV et au Recruteur concerné une licence pour les héberger, les visionner et les évaluer dans le cadre du processus de recrutement.",
        "legal.terms.li4_2": "<strong>Notre plateforme :</strong> Le design, le code, les logos et la marque CiaoCV sont notre propriété exclusive.",
        "legal.terms.h5": "5. Tarification et Paiements",
        "legal.terms.p5": "L'accès pour les Candidats est gratuit. Pour les Recruteurs, l'accès est soumis aux tarifs en vigueur décrits sur la page <a href=\"/tarifs\">Nos forfaits</a>. Les abonnements sont renouvelables tacitement sauf résiliation avant l'échéance.",
        "legal.terms.h6": "6. Limitation de responsabilité",
        "legal.terms.p6": "CiaoCV met tout en œuvre pour assurer la disponibilité du service, mais ne peut garantir une absence totale de pannes ou de bugs. Nous ne sommes pas responsables des conséquences d'une décision d'embauche (ou de non-embauche) prise via notre outil.",
        "legal.terms.h7": "7. Résiliation",
        "legal.terms.p7": "Nous nous réservons le droit de suspendre ou supprimer tout compte ne respectant pas ces conditions, sans préavis ni indemnité.",
        "legal.terms.h8": "8. Droit applicable",
        "legal.terms.p8": "Ces conditions sont régies par les lois de la province de Québec et du Canada. Tout litige sera soumis aux tribunaux du district judiciaire de Montréal."
    },
    en: {
        ...
        "legal.privacy.update_label": "Last updated:",
        "legal.privacy.update_date": "February 12, 2026",
        "legal.privacy.intro": "At CiaoCV, we believe recruitment should be human, transparent, and respectful. Protecting your privacy is at the heart of this commitment. This policy clearly explains how we treat your information.",
        "legal.privacy.h1": "1. Who are we?",
        "legal.privacy.p1": "CiaoCV is a video recruitment platform edited by CiaoCV Inc. We act as the data controller for your personal data.<br>For any questions: <a href=\"mailto:bonjour@ciaocv.com\">bonjour@ciaocv.com</a>.",
        "legal.privacy.h2": "2. What data do we collect?",
        "legal.privacy.li1": "<strong>For Candidates:</strong> Profile information (name, email, phone), CV, and most importantly your <strong>video responses</strong> to interviews.",
        "legal.privacy.li2": "<strong>For Recruiters:</strong> Professional information, company details, job postings.",
        "legal.privacy.li3": "<strong>Technical Data:</strong> IP address, browser type, and browsing data to ensure site security and performance.",
        "legal.privacy.h3": "3. Why do we use your data?",
        "legal.privacy.p3": "We use your data to:",
        "legal.privacy.use1": "<strong>Enable recruitment:</strong> Transmit your video applications to relevant recruiters.",
        "legal.privacy.use2": "<strong>Improve experience:</strong> Notify you of your application status or new opportunities.",
        "legal.privacy.use3": "<strong>Secure the platform:</strong> Prevent fraud and ensure confidentiality of exchanges.",
        "legal.privacy.h4": "4. Who do we share your data with?",
        "legal.privacy.p4_1": "Your application data (videos, CV) is only accessible to <strong>recruiters</strong> of the companies you apply to. We <strong>never</strong> sell your data to advertising third parties.",
        "legal.privacy.p4_2": "We collaborate with trusted subcontractors for hosting (e.g., secure servers in Canada/USA) and email sending, who are bound by strict confidentiality obligations.",
        "legal.privacy.h5": "5. Security of your videos",
        "legal.privacy.p5": "Your video interviews are stored securely and encrypted. They are only viewable via our secure platform by authorized recruiters.",
        "legal.privacy.h6": "6. Your rights",
        "legal.privacy.p6": "You stay in control. You can ask at any time for:",
        "legal.privacy.rights1": "Access to your data.",
        "legal.privacy.rights2": "Rectification of inaccurate information.",
        "legal.privacy.rights3": "Complete deletion of your account and videos (\"right to be forgotten\").",
        "legal.privacy.contact": "To exercise these rights, simply write to us at <a href=\"mailto:bonjour@ciaocv.com\">bonjour@ciaocv.com</a>.",
        "legal.privacy.h7": "7. Cookies",
        "legal.privacy.p7": "We use cookies essential for site operation (session, security) and anonymous analysis tools to understand how our site is used, without tracking you individually.",
        "legal.privacy.h8": "8. Changes",
        "legal.privacy.p8": "This policy may evolve. In case of major changes, we will inform you by email or via a notification on the platform.",

        "legal.terms.title": "Terms of Use",
        "legal.terms.update_label": "Last updated:",
        "legal.terms.update_date": "February 12, 2026",
        "legal.terms.intro": "Welcome to CiaoCV. By using our platform, you agree to play by the rules defined below. Our goal is to create a safe, professional, and benevolent recruitment environment.",
        "legal.terms.h1": "1. Purpose of service",
        "legal.terms.p1": "CiaoCV is a SaaS platform allowing companies (\"Recruiters\") to create video pre-selection processes and job seekers (\"Candidates\") to respond by video. We provide the technical tools, but we do not intervene in hiring decisions.",
        "legal.terms.h2": "2. Registration and Access",
        "legal.terms.p2": "To use CiaoCV, you must create an account. You agree to provide accurate information and keep your credentials confidential. You are responsible for all activity on your account.",
        "legal.terms.h3": "3. User Commitments",
        "legal.terms.p3_1": "<strong>Candidates:</strong> You agree to answer questions authentically and respectfully. ",
        "legal.terms.p3_2": "<strong>Recruiters:</strong> You agree to use the platform for real recruitment needs, not to discriminate against candidates, and to respect the confidentiality of their videos.",
        "legal.terms.p3_3": "It is strictly forbidden to publish hateful, defamatory, pornographic, or illegal content on CiaoCV.",
        "legal.terms.h4": "4. Intellectual Property",
        "legal.terms.li4_1": "<strong>Your content:</strong> Candidate videos remain their property. By submitting them, you grant CiaoCV and the relevant Recruiter a license to host, view, and evaluate them as part of the recruitment process.",
        "legal.terms.li4_2": "<strong>Our platform:</strong> The design, code, logos, and CiaoCV brand are our exclusive property.",
        "legal.terms.h5": "5. Pricing and Payments",
        "legal.terms.p5": "Access for Candidates is free. For Recruiters, access is subject to current rates described on the <a href=\"/tarifs\">Our Plans</a> page. Subscriptions are tacitly renewable unless terminated before maturity.",
        "legal.terms.h6": "6. Limitation of Liability",
        "legal.terms.p6": "CiaoCV makes every effort to ensure service availability but cannot guarantee total absence of failures or bugs. We are not responsible for the consequences of a hiring (or non-hiring) decision made via our tool.",
        "legal.terms.h7": "7. Termination",
        "legal.terms.p7": "We reserve the right to suspend or delete any account not respecting these terms, without notice or compensation.",
        "legal.terms.h8": "8. Governing Law",
        "legal.terms.p8": "These terms are governed by the laws of the province of Quebec and Canada. Any dispute will be submitted to the courts of the judicial district of Montreal."
    }
};
