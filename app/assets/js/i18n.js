...
const translations = {
    fr: {
        ...
        settings_company_access: "Accès entreprise",
        settings_company_access_help: "Les personnes ajoutées ici auront le même accès que vous : postes, affichages, candidats et paramètres.",
        ...
        poste_share_url_label: "Lien pour les candidats",
        poste_share_url_empty: "Créez un affichage pour ce poste pour obtenir le lien.",
        poste_create_affichage: "Créer un affichage",
    ...
    en: {
        ...
        settings_team: "Team",
        settings_company_access: "Company access",
        settings_company_access_help: "People added here will have the same access as you: positions, postings, candidates and settings.",
        settings_departments: "Departments", settings_notifications: "Notifications",
        ...
        poste_share_url_label: "Link for candidates",
        poste_share_url_empty: "Create a posting for this position to get the link.",
        poste_create_affichage: "Create posting",
