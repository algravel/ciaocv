...
<header class="app-header">
    ...
    <div class="app-header-right">
        ...
        <a href="employer-profile.php" class="app-header-avatar" aria-label="Mon profil" title="Mon profil">
            <?php if ($employerPhotoUrl): ?>
                <img src="<?= htmlspecialchars($employerPhotoUrl) ?>" alt="" class="avatar-img">
            <?php else: ?>
                <span class="avatar-initial"><?= htmlspecialchars($employerInitial) ?></span>
            <?php endif; ?>
        </a>
