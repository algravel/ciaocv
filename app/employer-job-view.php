        ...
        <div class="job-detail-card">
            ...
            <form method="POST" class="job-esplanade-bar" style="display:flex;align-items:center;gap:0.75rem;margin-top:1rem;flex-wrap:wrap;">
                ...
                <div class="esplanade-toggle-wrap" style="position:relative;display:inline-flex;align-items:center;gap:0.5rem;">
                    ...
                    <button type="button" id="esplanadeToggleBtn" class="esplanade-toggle" role="switch" aria-checked="<?= $showOnEsplanade ? 'true' : 'false' ?>" aria-label="Afficher sur l'Esplanade" title="L'Esplanade : c'est là que toutes les offres sont publiques pour les candidats." style="position:relative;width:56px;height:28px;border-radius:50px;border:2px solid #e5e7eb;background:<?= $showOnEsplanade ? '#2563EB' : '#e5e7eb' ?>;cursor:pointer;transition:background 0.2s, border-color 0.2s;flex-shrink:0;">
