        ...
        <div class="onboarding-content">
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="first_name" name="first_name" placeholder="Ton prénom" required value="<?= htmlspecialchars($_POST['first_name'] ?? '') ?>">
                </div>
            ...
            <button class="oauth-btn" disabled title="Bientôt disponible">
