...
<body>
    <div class="onboarding-container">
        ...
        <div style="margin: 2rem 0; text-align: center;">
            <h1 class="step-title"
                style="font-size: 2.25rem; font-weight: 800; letter-spacing: -0.025em; margin-bottom: 0.5rem;">C'est
                parti !</h1>
            <p class="step-subtitle" style="color: var(--text-secondary); font-size: 1.1rem;">On va te trouver un job
                qui te ressemble ✨</p>
        </div>
        ...
        <div class="onboarding-content glass" style="padding: 2rem; border-radius: 24px;">
            ...
            <form method="POST">
                <div class="form-group" style="margin-bottom: 1.25rem;">
                    ...
                    <input type="text" id="first_name" name="first_name" placeholder="Ton prénom" required
                        ...
                        style="border-radius: 12px; padding: 0.875rem 1rem;">
                </div>
                ...
                <div class="form-group" style="margin-bottom: 2rem;">
                    ...
                    <input type="password" id="password" name="password" placeholder="8 caractères minimum" required
                        minlength="8" style="border-radius: 12px; padding: 0.875rem 1rem;">
                </div>

                <button type="submit" class="btn btn-primary"
                    style="width: 100%; padding: 1rem; border-radius: 50px; font-weight: 700; font-size: 1rem;">Suivant
                    →</button>
            </form>
            ...
            <div class="oauth-divider"
                ...
                <span style="font-size: 0.85rem; text-transform: uppercase;">ou</span>
                <span style="flex: 1; height: 1px; background: var(--border);"></span>
            </div>

            <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                <a href="../oauth-google.php?action=login" class="btn btn-outline"
                    style="display: flex; align-items: center; justify-content: center; gap: 0.75rem; padding: 0.75rem; border-radius: 12px; border: 1px solid var(--border); color: var(--text); background: white; font-size: 0.9rem; font-weight: 600;">
        ...
        <div class="onboarding-footer" style="margin-top: 2rem; text-align: center;">
            <p style="color: var(--text-secondary); font-size: 0.9rem;">
                Déjà inscrit ? <a href="../index.php" style="color: var(--primary); font-weight: 600;">Se connecter</a>
            </p>
        </div>
    </div>
</body>
