...
<div class="rec-container">
    ...
    <div id="rec-step0" class="rec-card">
        ...
        <button type="button" id="rec-btn-continuer" class="rec-btn rec-btn-primary">Continuer vers le
            formulaire</button>
    </div>
    ...
    <div id="rec-step2" class="rec-hidden">
        <div class="rec-card">
            <h2><?= e($poste['title']) ?></h2>
            <p class="rec-meta" style="margin-bottom:0;"><?= e($poste['department'] ?? '') ?> •
                <?= e($poste['location'] ?? '') ?></p>
        </div>
        ...
        <div class="rec-card">
            ...
            <p class="rec-meta" style="margin-bottom:1rem;">Durée maximale : <?= $recordDuration ?> minute(s) pour
                l'ensemble des questions. Répondez de façon naturelle.</p>
            ...
            <div class="rec-controls">
                <button type="button" id="rec-btn-start" class="rec-btn rec-btn-primary"><i
                        class="fa-solid fa-circle"></i> Enregistrer</button>
                <button type="button" id="rec-btn-stop" class="rec-btn rec-btn-danger rec-hidden"><i
                        class="fa-solid fa-stop"></i> Arrêter</button>
                <button type="button" id="rec-btn-reprendre" class="rec-btn rec-btn-secondary rec-hidden"><i
                        class="fa-solid fa-rotate-right"></i> Reprendre</button>
                <button type="button" id="rec-btn-accepter" class="rec-btn rec-btn-success rec-hidden"><i
                        class="fa-solid fa-check"></i> Accepter</button>
            </div>
    ...
    <div id="rec-step3" class="rec-hidden">
        <div class="rec-card rec-confirmation">
            ...
            <h2>Merci !</h2>
            <p class="rec-desc">Votre candidature a bien été envoyée. L'entreprise examinera votre vidéo et vous
                contactera si votre profil est retenu.</p>
            <a href="<?= SITE_URL ?>" class="rec-btn rec-btn-secondary"><i class="fa-solid fa-arrow-left"></i> Retour au
                site</a>
        </div>
    </div>
</div>
...
<script>
    (function () {
        ...
        function goToStep(n) {
            ...
            // Start tracking time when arriving at step 2 (recording)
            if (n === 2 && recordingStepStartTime === 0) {
                recordingStepStartTime = Date.now();
            }
        }
        ...
        // ─── Reprendre ──────────────────────────────────────────────────────
        function reprendre() {
            retakesCount++; // Increment retake stats
