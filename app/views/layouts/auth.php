...
<head>
    ...
    <style>
        ...
        .page-login footer { flex-shrink: 0; }
        ...
        .forgot-overlay.active { opacity: 1; visibility: visible; pointer-events: auto; }
        .forgot-modal {
            background: var(--card-bg);
            border: 1px solid var(--border);
            border-radius: var(--radius-xl);
        ...
        .forgot-overlay.active .forgot-modal { transform: translateY(0) scale(1); }
        .forgot-modal-close {
        ...
        .forgot-modal-close:hover { background: var(--bg-alt, rgba(255,255,255,0.05)); color: var(--text); }
        .forgot-modal h3 { font-size: 1.35rem; font-weight: 800; margin-bottom: 0.5rem; color: var(--text); letter-spacing: -0.02em; }
        .forgot-modal .forgot-desc { font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 1.5rem; line-height: 1.5; }
        .forgot-modal .form-group { margin-bottom: 1.25rem; }
        .forgot-modal .form-group label { display: block; margin-bottom: 0.5rem; font-weight: 600; font-size: 0.9rem; color: var(--text); }
        .forgot-modal .turnstile-placeholder {
            background: var(--bg); border: 1px dashed var(--border); border-radius: var(--radius);
            padding: 1.25rem; text-align: center; color: var(--text-secondary); font-size: 0.8rem;
            margin-bottom: 1.5rem; min-height: 65px;
            display: flex; align-items: center; justify-content: center; gap: 0.5rem;
        }
        .forgot-modal .turnstile-placeholder svg { opacity: 0.5; }
