    ...
    <div class="login-container">
        <div class="hero-text">
            <div class="login-header">
                <a href="<?= APP_URL ?>/gestion" class="login-logo-link">
        ...
        <div class="hero-form">
            <div class="login-card">
                ...
                <div class="login-footer">
                    <a href="<?= APP_URL ?>/connexion" class="login-forgot-link">Espace recruteur</a>
                    <span class="login-footer-sep">·</span>
                    <a href="<?= SITE_URL ?>" class="login-forgot-link">Retour au site</a>
                </div>
            </div>
        </div>
    </div>
